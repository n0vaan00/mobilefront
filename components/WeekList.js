...
const Weeklist = ({newPrices, dates}) => {
  ...
  return (
    <List.Section title="">
      <List.Accordion
        title="Näytä tuntihinnat" descriptionStyle={{color: 'white'}} titleStyle={{color:'white', backgroundColor:'#808080'}} 
        style={{backgroundColor:'#808080'}}>
        <List.Item title={dates[0] + '00:00'} description={newPrices[0]}
